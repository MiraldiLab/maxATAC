...
> If you want to ask a question, we assume that you have read the available [Documentation](#add link).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read the [documentation](#add link). If you are looking for support, you might want to check [this section](#i-have-a-question)).
...
- Make sure that you are using the latest version.
- Read the [documentation](# add link) carefully and find out if the functionality is already covered, maybe by an individual configuration.
...
<!-- omit in toc -->
## Attribution
This guide is based on the **contributing-gen**. [Make your own](https://github.com/torus-online/torus/blob/master/CONTRIBUTING.MD)!
