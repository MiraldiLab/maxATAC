...
from maxatac.analyses.pc_prediction import run_pc_prediction
from maxatac.analyses.pc_training import run_pc_training
...
def assert_and_fix_args(args):
    ...
    if args.func == run_pc_prediction:
        #assert_and_fix_args_for_prediction(args)
        pass
    elif args.func == run_pc_training:
...
def get_parser():
    ...
    predict_parser.set_defaults(func=run_pc_prediction)
    ...
    train_parser.set_defaults(func=run_pc_training)
